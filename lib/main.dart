...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    ...
    final qrCodeModal = WalletConnectQrCodeModal(connector: walletConnect);
    final _provider = EthereumWalletConnectProvider(qrCodeModal.connector);
    ...
    qrCodeModal.registerListeners(
      onConnect: (session) async {
        ...
        print("@@@@");
        final signature = await _provider.personalSign(
            message: 'Hoge!', address: walletAddress, password: '');
        await qrCodeModal.openWalletApp();
        print("############ signature!!!");
        print(signature);
        // _provider.
      },
